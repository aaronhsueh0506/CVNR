...
def denoise(model_path, input_wav, output_wav):
    ...
    # 載入音檔
    audio, orig_sr = torchaudio.load(input_wav)
    audio = audio[0]  # mono
    if orig_sr != SR:
    ...
    torchaudio.save(output_wav, output.unsqueeze(0), SR)
...
if __name__ == '__main__':
    ...
    denoise(args.model, args.input, args.output)
