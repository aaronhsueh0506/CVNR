...
4. **V4: IMCRA + OMLSA** - 產品級先進方案 (v2.1.1 最強 segSNR +5.68dB)
...
- ✅ **v2.1.1**: V4 配置修復（最強 segSNR）、V3 系列 alpha_xi=0.96 同步
- ✅ 模塊化設計，易於理解和擴展
...
|------|------|-------------|----------|-----|------|------|
| 🥇 1 | **V4 (IMCRA-OMLSA)** | **+5.68 dB** | -7.80 | 96.8 | 1.23 | 0.21 |
| 🥈 2 | **RNNoise** | +3.97 dB | 3.93 | 66.4 | 1.69 | 0.90 |
| 🥉 3 | **V3 (SPP-MMSE)** | +3.96 dB | -5.26 | 99.7 | 1.47 | 0.17 |
| 4 | V2 (Wiener) | +3.86 dB | -4.70 | 108.2 | 1.28 | 0.14 |
| 5 | V3-4 (Laplacian) | +3.79 dB | -4.27 | 103.9 | 1.37 | 0.18 |
| 6 | Speex | +3.12 dB | 6.14 | 69.9 | 1.44 | 0.88 |
| 7 | V1 (Spectral Sub) | +2.79 dB | -4.05 | 99.9 | 1.47 | 0.16 |
| 8 | V3-2 (MMSE-LSA) | +2.79 dB | -4.21 | 101.5 | 1.49 | 0.16 |
| 9 | V3-3 (PMMSE) | +2.68 dB | -4.07 | 102.1 | 1.45 | 0.16 |

#### PESQ 排名（感知語音質量，1.0-4.5 分）- 參考指標

| 排名 | 方法 | Enhanced PESQ | PESQ 改善 Δ | STOI | 特點 |
|------|------|---------------|-------------|------|------|
| 🥇 1 | **V3-2 (MMSE-LSA)** | **1.780** | **+0.261** | 0.827 | **最佳 PESQ**，頻譜最平滑 |
| 🥈 2 | **V1 (Spectral Sub)** | 1.753 | +0.234 | 0.864 | 簡單高效 |
| 🥉 3 | **V3 (SPP-MMSE)** | 1.747 | +0.228 | 0.843 | 平衡性能 |
| 4 | **V3-3 (PMMSE)** | 1.731 | +0.211 | 0.838 | 感知優化 |
| 5 | **RNNoise** | 1.695 | +0.436 | **0.897** | 深度學習，**STOI 最佳** |
| 6 | **V3-4 (Laplacian)** | 1.648 | +0.129 | **0.872** | STOI 第二 |
| 7 | **Speex** | 1.436 | +0.176 | 0.878 | 傳統基準 |
| 8 | V2 (Wiener) | 1.391 | -0.129 | 0.847 | 基礎方法 |
| 9 | V4 (IMCRA-OMLSA) | 1.320 | -0.200 | 0.866 | 強降噪，PESQ 較低 |

**🎉 v2.1.1 關鍵成果**：
- ✅ **V4 segSNR 最佳** (+5.68 dB)，超越 RNNoise (+3.97 dB)
- ✅ **V3-2 PESQ 最佳** (1.780)，頻譜質量最優
- ✅ **V4 配置修復成功**：alpha_d=0.88, L=120, alpha_g=0.88
- ✅ **V3 系列參數同步**：alpha_xi=0.96 統一到所有 V3 變體
...
### v2.1.1 (2026-01-06) ✨ 最新
- ✅ **V3 系列參數同步優化**: alpha_xi=0.96 同步到所有 V3 變體
- ✅ **V4 配置修復**: 修復 alpha_d, L, alpha_g 參數錯誤
  - V4 恢復最佳性能：segSNR +5.68 dB（超越 RNNoise）
- ✅ 暫時禁用 V4 的 noise_tracking 和 snr_adaptive 以提升穩定性
...
**推薦使用 V4（最強 segSNR）、V3-2（最佳 PESQ）或 V3（平衡性能）版本以獲得最佳降噪效果！**
